...
__export(dist_exports, {
  ...
  download: () => import_chunk_7LKYSON6.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_7LKYSON6.getBinaryName,
  getCacheDir: () => import_chunk_5T2KHPZI.getCacheDir,
  getProxyAgent: () => import_chunk_KDPLGCY6.getProxyAgent,
  getVersion: () => import_chunk_7LKYSON6.getVersion,
  maybeCopyToTmp: () => import_chunk_7LKYSON6.maybeCopyToTmp,
  overwriteFile: () => import_chunk_5T2KHPZI.overwriteFile,
  plusX: () => import_chunk_7LKYSON6.plusX,
  vercelPkgPathRegex: () => import_chunk_7LKYSON6.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_7LKYSON6 = require("./chunk-7LKYSON6.js");
